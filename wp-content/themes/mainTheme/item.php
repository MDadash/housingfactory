    ...
    <section class="appartment container">
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 appartment__rs">
                <h2 class="appartment__title"><?php echo $currentFlat['location']['locality-name']; ?>,<br> <?php echo $currentFlat['location']['address']; ?></h2>
                <div class="appartment__id-wrapper"><span>ID <span><?php echo $currentFlat['@attributes']['internal-id']; ?></span></span><a class="appartment__rooms"><?php echo $currentFlat['rooms']; ?> комнатная</a></div>
                <strong class="appartment__price"><?php echo $currentFlat['price']['value']; ?> &#8381;</strong>
                <div class="appartment__info-wr"><span class="appartment__info-title">Район: </span><?php echo $currentFlat['location']['sub-locality-name']; ?></div>
                <div class="appartment__info-wr"><?php echo $currentFlat['location']['address']; ?></div>
                <div class="appartment__info-block-wr">
                    <div class="appartment__info-block"><span class="appartment__info-block-title">Жилая</span><strong class="appartment__info-block-desc"><?php echo $currentFlat['living-space']['value']; ?> м<sup>2</sup></strong></div>
                    <div class="appartment__info-block"><span class="appartment__info-block-title">Кухня</span><strong class="appartment__info-block-desc"><?php echo $currentFlat['kitchen-space']['value']; ?> м<sup>2</sup></strong></div>
                </div>
                <div class="appartment__info-block"><span class="appartment__info-block-title">Этажность</span><strong class="appartment__info-block-desc"><?php echo $currentFlat['floor']; ?>/<?php echo $currentFlat['floors-total']; ?></strong></div>
